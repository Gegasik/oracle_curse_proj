--check user in DB
create or replace procedure CheckUser (inUsername in char, inPassword in char)
is 
  cuser number;
...
--authorization users
create or replace procedure AuthorizeUser (inUsername in char, inPassword in char)
is 
 cpassw char(2000);
begin
  cpassw := inPassword;
